    ...
    <>
      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <button className="outline-none rounded-full focus-visible:ring-2 focus-visible:ring-h_cyan">
            <Avatar className="size-8 ring-2 ring-h_cyan hover:ring-h_cyanDark transition-all cursor-pointer">
              <AvatarImage
                src={avatarSrc ?? "/noAvatar.png"}
                alt={displayName}
              />
              <AvatarFallback className="bg-h_cyanDark text-black text-sm font-semibold">
                {initials}
              </AvatarFallback>
            </Avatar>
          </button>
