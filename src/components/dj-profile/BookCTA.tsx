            ...
            {modal === "auth" && (
              <>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    You need a DJcovery account to send booking requests. Sign
                    in or create a free organizer account in seconds.
                  </DialogDescription>
                </DialogHeader>
            ...
            {modal === "upgrade" && (
              <>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Booking requests are reserved for promoters, venues, and
                    event organizers. Upgrade your account to unlock
                    professional tools.
                  </DialogDescription>
                </DialogHeader>
