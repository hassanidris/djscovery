...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        "data-open:animate-in data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0 fixed inset-0 isolate z-50 bg-black/60 duration-200 supports-backdrop-filter:backdrop-blur-sm",
        className,
      )}
      {...props}
    />
...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "bg-muted/50 -mx-4 -mb-4 flex flex-col-reverse gap-3 rounded-b-xl border-t border-white/10 p-6 sm:flex-row sm:justify-end",
        className,
      )}
