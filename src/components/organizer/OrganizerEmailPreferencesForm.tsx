...
const PREFS: Pref[] = [
  {
    ...
    description:
      "When a DJ accepts, declines, or messages you about a booking.",
    name: "bookingEmails",
    defaultChecked: true,
  },
  {
    label: "Gig applications",
    description: "When a DJ applies to one of your gigs.",
...
export default function OrganizerEmailPreferencesForm({
  bookingEmails,
  applicationEmails,
  platformUpdates,
}: {
