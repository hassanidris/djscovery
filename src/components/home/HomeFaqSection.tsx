          ...
          <div className="flex flex-col gap-4 lg:w-72 lg:shrink-0">
            <div className="flex items-center gap-2.5">
              <div className="bg-h_red/10 border-h_red/20 flex size-9 shrink-0 items-center justify-center rounded-xl border">
                <CircleHelp className="text-h_red/80 h-4.5 w-4.5" />
              </div>
            ...
            <Link
              href="/faq"
              className="text-h_red/80 hover:text-h_red/80Dark mt-2 inline-flex items-center gap-1.5 text-sm font-semibold transition-colors"
            >
              View all FAQs
