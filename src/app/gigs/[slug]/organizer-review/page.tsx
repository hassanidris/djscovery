...
import { getOrganizerReviewContextBySlug } from "@/lib/queries/gigs";
import { OrganizerReviewForm } from "@/components/reputation/OrganizerReviewForm";
...
export async function generateMetadata({
  ...
  return { title: `Review Organizer | DJcovery` };
}
...
export default async function OrganizerReviewPage({
  ...
  const context = await getOrganizerReviewContextBySlug(slug, user.id);
      ...
      <div className="mx-auto max-w-2xl px-4 py-10 md:px-8">
        ...
        {context.reviewWindowOpen && (
          <>
            ...
            <OrganizerReviewForm
              gigId={context.gigId}
              organizerProfileId={context.organizerProfileId}
