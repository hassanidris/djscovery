          ...
          <div className="flex flex-col gap-5">
            <div className="flex items-center gap-3">
              <div className="bg-h_red/10 border-h_red/20 flex size-10 shrink-0 items-center justify-center rounded-xl border">
                <Headphones className="text-h_red/80 h-5 w-5" />
              </div>
            ...
            <h1 className="font-heading text-4xl text-white md:text-6xl">
              About <span className="text-h_red/80">DJcovery</span>
            </h1>
            ...
            <div className="flex flex-col gap-16">
                ...
                <div className="flex flex-col gap-4 text-gray-400">
                  <div className="grid gap-3 sm:grid-cols-2">
                    {[
                      ...
                      >
                        <CheckCircle2 className="text-h_red/80 mt-0.5 h-4 w-4 shrink-0" />
              ...
              <section id="join-community" className="scroll-mt-24">
                ...
                <div className="flex flex-col gap-6 text-gray-400">
                  ...
                  <div className="grid gap-4 sm:grid-cols-3">
                    <CtaCard
                      icon={<Music2 className="text-h_red/80 h-5 w-5" />}
                      title="I'm a DJ"
                    ...
                    />
                    <CtaCard
                      icon={<Users className="text-h_red/80 h-5 w-5" />}
  ...
  return (
    <div className="flex flex-col gap-4 rounded-2xl border border-white/5 bg-white/2 p-5">
      <div className="flex items-center gap-2.5">
        <span className="bg-h_red/10 text-h_red/80 flex size-7 items-center justify-center rounded-lg">
          {icon}
        </span>
...
function CtaCard({
  ...
  return (
    ...
    >
      ...
      <div className="text-h_red/80 mt-auto flex items-center gap-1.5 text-xs font-semibold">
        {label}
